"use strict";
(self["webpackChunkdoris_app"] = self["webpackChunkdoris_app"] || []).push([[301],{
...
function PageDiscover() {
    ...
    function getTableData() {
        ...
        getTableDataService(PageDiscover_object_spread({
            ...
            next: ({ data, ok })=>PageDiscover_async_to_generator(function*() {
                    ...
                    if (ok) {
                        const rowsData = (0,utils_data/* convertColumnToRow */.HL)(data.results.getTableData.frames[0]);
    ...
    function getTopData() {
        ...
        getTopDataService(PageDiscover_object_spread({
            ...
            next: ({ data, ok })=>{
                if (ok) {
                    const rowsData = (0,utils_data/* convertColumnToRowViaFieldsType */.ml)(data.results.getTableTopData.frames[0], tableFields);
                    setTopData(rowsData);
                }
            },
            error: (err)=>{
    ...
    function getTraceData(trace_id) {
        ...
        (0,traces/* getTableDataTraceService */.hA)(PageDiscover_object_spread({
            selectdbDS
        }, payload)).subscribe({
            next: ({ data, ok })=>{
                if (ok) {
